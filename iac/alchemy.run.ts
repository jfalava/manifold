...
export const ManifoldApi = Cloudflare.Worker("ManifoldApi", {
  ...
  env: {
    ...
    MANIFOLD_GITHUB_CLIENT_ID: Config.String("MANIFOLD_GITHUB_CLIENT_ID"),
    MANIFOLD_GITHUB_ALLOWED_USER_ID: Config.String("MANIFOLD_GITHUB_ALLOWED_USER_ID"),
