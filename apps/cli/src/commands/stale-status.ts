...
export const staleStatusCommand = Command.make(
  ...
  ({
    ...
    Effect.gen(function* () {
      ...
      const credentials = {
        clientId:
          resolveValue(mangadexClientId, "MANGADEX_CLIENT_ID", "ALCHEMY_SECRET_MANGADEX_CLIENT_ID") ?? "",
        clientSecret:
          resolveValue(mangadexClientSecret, "MANGADEX_CLIENT_SECRET", "ALCHEMY_SECRET_MANGADEX_CLIENT_SECRET") ?? "",
        username:
          resolveValue(mangadexUsername, "MANGADEX_USERNAME", "ALCHEMY_SECRET_MANGADEX_USERNAME") ?? "",
        password:
          resolveValue(mangadexPassword, "MANGADEX_PASSWORD", "ALCHEMY_SECRET_MANGADEX_PASSWORD") ?? "",
      };
